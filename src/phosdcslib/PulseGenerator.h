...
class PulseGenerator : public TObject
  ...
  public:
    ...
    // Raw Read Out
    double        GetRawFormatCapa()        const
      {
        return fgCapa ;
      }
    static double GetRawFormatHighCharge()
    {
      return fgHighCharge ;
    }
    static double GetRawFormatHighGain()
    {
      return fgHighGain ;
    }
    static double GetRawFormatHighLowGainFactor()
    {
      return fgHighLowGainFactor ;
    }
    static double GetRawFormatLowCharge()
    {
      return ( fgHighCharge *  fgHighLowGainFactor ) ;
    }
    static double GetRawFormatLowGain()
    {
      return ( fgHighGain / fgHighLowGainFactor ) ;
    }
    int           GetRawFormatOrder()       const
      {
        return fgOrder ;
      }
    static int    GetRawFormatTimeBins()
    {
      return fkTimeBins ;
    }
    static double GetRawFormatTimeMax()
    {
      return fgTimeTrigger*fkTimeBins ;
    }
    double        GetRawFormatTimePeak()    const
      {
        return fgTimePeak ;
      }
    double        GetRawFormatTimeTrigger() const
      {
