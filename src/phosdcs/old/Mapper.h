...
class Mapper
{
 public:
  ...
  //Function to generate Acive Frontencard List (AFL) for each of the four readout partitions
  // void GenerateAFL(int startZ, int endZ, int startX, int endX, int mID, long int *afl[RCUS_PER_MODULE]);
